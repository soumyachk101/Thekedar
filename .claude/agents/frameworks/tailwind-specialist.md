...
- **Accessibility isn't styling's excuse**: visible focus states (don't remove focus rings without replacement), sufficient contrast (see `.thekedar/knowledge/review-checklists/accessibility.md`).
...
- Keep class names statically analyzable (purge-safe); preserve focus states + contrast (`.thekedar/knowledge/review-checklists/accessibility.md`).
