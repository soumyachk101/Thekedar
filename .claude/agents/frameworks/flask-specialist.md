...
5. **Self-check** acceptance boxes; consult `.thekedar/knowledge/pitfalls/python.md`, `.thekedar/knowledge/patterns/api-design.md`.
...
- **Correct status codes + one error envelope** (`.thekedar/knowledge/pitfalls/api-http.md`); authz checked per route, scoped to the user (IDOR).
...
- Validate all request input; parameterized queries only; scope records to the user (`.thekedar/knowledge/security/authz-checklist.md`).
