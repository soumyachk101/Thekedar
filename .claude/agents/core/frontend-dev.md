...
- Never invent APIs or hooks. When installed, `.thekedar/knowledge/pitfalls/react.md` and `typescript-javascript.md` list the specific traps (deprecated lifecycle, hook-rule violations, effect-dep bugs, state mutation, invented Array/String methods) — consult them; uncertainty = check, not guess.
